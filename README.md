...
`target_minus_vintage` and emits a deprecation warning. The deprecated `first_forecast_horizon`
argument can be supplied to shift this distance so that the first forecast is horizon `0`; supply
`forecast_horizon` explicitly in new code.
